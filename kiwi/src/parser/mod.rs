...
impl Key {
    pub fn from_cg_code(code: u16, char: Option<char>) -> Self {
        match code {
            ...
            0x08 => Key::Char('c'), 0x09 => Key::Char('v'), 0x0A => Key::Char('§'), 0x0B => Key::Char('b'),
            0x0C => Key::Char('q'), 0x0D => Key::Char('w'), 0x0E => Key::Char('e'), 0x0F => Key::Char('r'),
            0x10 => Key::Char('y'), 0x11 => Key::Char('t'), 0x12 => Key::Char('1'), 0x13 => Key::Char('2'),
            0x14 => Key::Char('3'), 0x15 => Key::Char('4'), 0x16 => Key::Char('6'), 0x17 => Key::Char('5'),
            0x18 => Key::Char('='), 0x19 => Key::Char('9'), 0x1A => Key::Char('7'), 0x1B => Key::Char('-'),
            0x1C => Key::Char('8'), 0x1D => Key::Char('0'), 0x1E => Key::Char(']'), 0x1F => Key::Char('o'),
            0x20 => Key::Char('u'), 0x21 => Key::Char('['), 0x22 => Key::Char('i'), 0x23 => Key::Char('p'),
            0x25 => Key::Char('l'), 0x26 => Key::Char('j'), 0x27 => Key::Char('\''), 0x28 => Key::Char('k'),
            0x29 => Key::Char(';'), 0x2A => Key::Char('\\'), 0x2B => Key::Char(','), 0x2C => Key::Char('/'),
            0x2D => Key::Char('n'), 0x2E => Key::Char('m'), 0x2F => Key::Char('.'), 0x32 => Key::Char('`'),
